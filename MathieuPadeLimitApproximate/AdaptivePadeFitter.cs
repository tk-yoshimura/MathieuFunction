...
namespace MathieuPadeApproximate {
    public class AdaptivePadeFitter<N> : PadeFitter<N> where N : struct, IConstant {
        ...
        public (Vector<N> parameters, bool success) Fit(Vector<N> weights, Func<Vector<N>, Vector<N>, Vector<N>, bool[]> needs_increase_weight, MultiPrecision<N>? norm_cost = null, int iter = 64) {
